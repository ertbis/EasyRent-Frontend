        ...
        <div className="pt-16 md:pt-0 w-full m-0 h-screen md:h-[31rem] md:w-[33%] px-8 py-16 bg-white md:rounded-xl shadow-lg md:mr-16 md:h-full text-grey">
          ...
          <form  className="flex pb-8 flex-col justify-between h-[85%] w-full md:space-y-4">
             <div className='w-[90%]'>
                ...
                <div className="flex justify-start mb-8 items-center space-x-2">

                        <div>
                            <input
                            type="number"
                            className="appearance-none border w-28 rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"

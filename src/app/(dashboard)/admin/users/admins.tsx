  ...
  <table className="min-w-full border border-gray-300 text-[#343A40]">
    ...
    <thead>
      <tr className="text-[#343A40]">
        ...
        <th className="py-2 font-medium px-4 border border-gray-300">Admin Level</th>
...
const  TableRow:FC<any> = ({data, index}) => {
  ...
  return (
    ...
    <td className="py-2 px-4 border border-gray-300">
              ...
              <td className="py-2 px-4 border border-gray-300">{data?.admin?.level}</td>
              <td className="py-2 px-4 border border-gray-300">
              <div className="flex gap-x-[1rem]">

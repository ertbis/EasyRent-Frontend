          ...
          <div className=' text-grey-light flex  items-center  justify-between mb-2  w-full h-16  '>
            ...
            <div className='flex  items-center  '>
               ...
               <div className='flex-1'>
                      ...
                      <h2 className="text-blue-800 w-[100%] text-2xl font-bold mt-4 ">Add Account Details</h2>
            ...
            <form  className="flex-1 flex flex-wrap  flex-col justify-between m-auto  w-full md:space-y-4">
